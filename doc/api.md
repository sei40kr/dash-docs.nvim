...
```lua
function Docset.open(name: string, docsets_dir: string)
  -> Docset?
  2. string?
```
...
@*param* `name` — The name of the docset to open

@*param* `docsets_dir` — The path to the docsets directory

@*return* — Returns a Docset as the 1st value and nil as the 2nd value on success. Returns nil as the 1st value and an error message as the 2nd value on failure.

## search


```lua
(method) Docset:search(pattern: string)
  -> DocsetItem[]?
  2. string?
```
...
@*return* — Returns a list of DocsetItem as the 1st value and nil as the 2nd value on success. Returns nil as the 1st value and an error message as the 2nd value on failure.
